...
<html lang="en">
  ...
  <body style="padding-top: 72px;">
    ...
    <!-- Hero Section-->
    <section class="hero py-6 py-lg-7 text-white dark-overlay"><img class="bg-image" src="./resources/bootstrap-5/html/img/photo/photo-1467987506553-8f3916508521.jpg" alt="Text page">
        ...
        <div class="row">
          <div class="col-xl-8 col-lg-10 mx-auto">                               
            <div class="text-content">
              ...
              <figure class="figure mb-3"><img class="figure-img img-fluid" src="./resources/bootstrap-5/html/img/photo/photo-1482463084673-98272196658a.jpg" alt="Example blog post alt.">
