  ...
  <body style="padding-top: 72px;">
    ...
    <section class="hero py-5 py-lg-7">
      <div class="container position-relative">
        ...
        <h1 class="hero-heading mb-0">FAQ</h1>
      </div>
    </section>
    <section class="py-6">
      <div class="container">
        <div class="row">   
          <div class="col-xl-8 col-lg-10 mx-auto">
            <div class="text-content">
              <h3>1. Terms</h3>
              <p>This website, <a href="https://example.com">https://example.com</a>, is operated by Jack Flag and Bootstrapious. Throughout the site, the terms �쐗e��, �쐕s�� and �쐎ur�� refer to Jack Flag and Bootstrapious. We offer혻this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
              <p>By visiting our site and/ or purchasing something from us, you engage in our �쏶ervice�� and agree to be bound by the following terms and conditions (�쏷erms of Service��, �쏷erms��), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply 혻to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content.</p>
