        ...
        <div class="row">   
          <div class="col-xl-8 col-lg-10 mx-auto">
            <div class="text-content">
              <h3 class="text-primary" style="font-family: 'GmarketSansMedium';">1. 많이 하는 질문</h3>
              ...
              <h3 class="text-primary" style="font-family: 'GmarketSansMedium';">2. 많이 하는 질문</h3>
              <ol type="a">
              ...
              <h3 class="text-primary" style="font-family: 'GmarketSansMedium';">3. 많이 하는 질문</h3>
              ...
              <h3 style="font-family: 'GmarketSansMedium';">4. 많이 하는 질문</h3>
              <ol type="a">
